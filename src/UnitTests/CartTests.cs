...
namespace UnitTests
{
    public class CartTests
    {
        ...
        public void AddProduct_Test()
        {
            ...
            var testDictionary = new Dictionary<Product, int>();
            testDictionary.Add(product1, 2);
        ...
        public void TotalProduct_Test()
        {
            ...
            var product1 = new Product() { Id = 1, Name = "TestProduct1" };
            _cart.Products.Add(product1, 1);
            int expectedResault = 1;

            //Act

            int productsInCart = _cart.TotalProducts();

            //Assert

            Assert.That(productsInCart, Is.EqualTo(expectedResault));
        }
        [Test]
        public void TotalPrice_Test()
        {
            ...
            int expectedResault = 50;

            //Act

            int totalPrice = _cart.TotalPrice();

            //Assert

            Assert.That(totalPrice, Is.EqualTo(expectedResault));
        }
    }
